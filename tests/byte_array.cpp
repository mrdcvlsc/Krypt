...
int main() {
    unsigned char plain[16] = {0x00, 0x11, 0x22, 0x33, 0x44, 0x55, 0x66, 0x77, 0x88, 0x99, 0xaa, 0xbb};

    unsigned char aes128key[16] = {0x00, 0x01, 0x02, 0x03, 0x04, 0x05, 0x06, 0x07,
                                   0x08, 0x09, 0x0a, 0x0b, 0x0c, 0x0d, 0x0e, 0x0f};

    unsigned char IV[16] = {0x10, 0xa1, 0xf2, 0x0a, 0xb4, 0x55, 0x76, 0x00,
...

    {
        ...
        if (memcmp(recover.array, plain, sizeof(plain))) {
            throw std::logic_error("Wrong decryption output");
        }
    }
...

    {
        ...
        if (memcmp(cipher.array, plain, sizeof(plain))) {
            throw std::logic_error("Wrong decryption output");
        }
    }
