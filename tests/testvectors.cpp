...
int main() {
    ...
    std::cout << "BlockCipher, AES128: \n";
    {
        ...
        unsigned char cipherTarget[] = {0x69, 0xc4, 0xe0, 0xd8, 0x6a, 0x7b, 0x04, 0x30,
    ...
    std::cout << "BlockCipher, AES192: \n";
    {
        ...
        unsigned char cipherTarget[] = {0xdd, 0xa9, 0x7c, 0xa4, 0x86, 0x4c, 0xdf, 0xe0,
    ...
    std::cout << "BlockCipher, AES256: \n";
    {
        ...
        unsigned char cipherTarget[] = {0x8e, 0xa2, 0xb7, 0xca, 0x51, 0x67, 0x45, 0xbf,
    ...
    std::cout << "Padding, LENGTH_4TO8_ZeroNulls: \n";
    {
        unsigned char plain[] = {0x00, 0x11, 0x22, 0x33};

        unsigned char padded_plain[] = {0x00, 0x11, 0x22, 0x33, 0x00, 0x00, 0x00, 0x00};
    ...
    std::cout << "Padding, LENGTH_4TO8_PKCS_5_7: \n";
    {
        unsigned char plain[] = {0x00, 0x11, 0x22, 0x33};

        unsigned char padded_plain[] = {0x00, 0x11, 0x22, 0x33, 0x04, 0x04, 0x04, 0x04};
    ...
    std::cout << "Padding, LENGTH_4TO8_ISO_IEC_7816_4: \n";
    {
        unsigned char plain[] = {0x00, 0x11, 0x22, 0x33};

        unsigned char padded_plain[] = {0x00, 0x11, 0x22, 0x33, 0x80, 0x00, 0x00, 0x00};
    ...
    std::cout << "Padding, LENGTH_4TO8_ANSI_X9_23: \n";
    {
        unsigned char plain[] = {0x00, 0x11, 0x22, 0x33};

        unsigned char padded_plain[] = {0x00, 0x11, 0x22, 0x33, 0x00, 0x00, 0x00, 0x04};
    ...
    std::cout << "ModeECB, ECB_ZeroNulls_AES128: \n";
    {
        Krypt::Bytes plain[] = {0x00, 0x01, 0xa2, 0xb3, 0xff, 0x74, 0x32, 0xcd};

        Krypt::Bytes aeskey[] = {0x00, 0x01, 0x02, 0x03, 0x04, 0x05, 0x06, 0x07,
                                 0x08, 0x09, 0x0a, 0x0b, 0x0c, 0x0d, 0x0e, 0x0f};
    ...
    std::cout << "ModeECB, ECB_PKCS_5_7_AES128: \n";
    {
        Krypt::Bytes plain[] = {0x00, 0x01, 0xa2, 0xb3, 0xff, 0x74, 0x32, 0xcd};
    ...
    std::cout << "ModeECB, ECB_ISO_IEC_7816_4_AES128: \n";
    {
        Krypt::Bytes plain[] = {0x00, 0x01, 0xa2, 0xb3, 0xff, 0x74, 0x32, 0xcd};
    ...
    std::cout << "ModeECB, ECB_ANSI_X9_23_AES128: \n";
    {
        Krypt::Bytes plain[] = {0x00, 0x01, 0xa2, 0xb3, 0xff, 0x74, 0x32, 0xcd};
    ...
    std::cout << "ModeECB, ECB_ZeroNulls_AES192: \n";
    {
        Krypt::Bytes plain[] = {0x00, 0x01, 0xa2, 0xb3, 0xff, 0x74, 0x32, 0xcd};

        Krypt::Bytes aeskey[] = {0xa0, 0xb1, 0x02, 0x03, 0xd4, 0x05, 0xf6, 0xa7, 0x08, 0xc9, 0x0a, 0x0b,
                                 0x0c, 0xed, 0x0e, 0xff, 0xfc, 0xed, 0x0e, 0x0f, 0x04, 0x05, 0x16, 0x87};
    ...
    std::cout << "ModeECB, ECB_PKCS_5_7_AES192: \n";
    {
        Krypt::Bytes plain[] = {0x00, 0x01, 0xa2, 0xb3, 0xff, 0x74, 0x32, 0xcd};
    ...
    std::cout << "ModeECB, ECB_ISO_IEC_7816_4_AES192: \n";
    {
        Krypt::Bytes plain[] = {0x00, 0x01, 0xa2, 0xb3, 0xff, 0x74, 0x32, 0xcd};
    ...
    std::cout << "ModeECB, ECB_ANSI_X9_23_AES192: \n";
    {
        Krypt::Bytes plain[] = {0x00, 0x01, 0xa2, 0xb3, 0xff, 0x74, 0x32, 0xcd};
    ...
    std::cout << "ModeECB, ECB_ZeroNulls_AES256: \n";
    {
        Krypt::Bytes plain[] = {0x00, 0x01, 0xa2, 0xb3, 0xff, 0x74, 0x32, 0xcd};

        Krypt::Bytes aeskey[] = {0xa0, 0xb1, 0x02, 0x03, 0xd4, 0x05, 0xf6, 0xa7, 0x08, 0xc9, 0x0a,
                                 0x0b, 0x0c, 0xed, 0x0e, 0xff, 0xfc, 0xed, 0x0e, 0x0f, 0x04, 0x05,
                                 0x16, 0x87, 0x00, 0xaa, 0x33, 0x80, 0xed, 0xf2, 0x33, 0x43};
    ...
    std::cout << "ModeECB, ECB_PKCS_5_7_AES256: \n";
    {
        Krypt::Bytes plain[] = {0x00, 0x01, 0xa2, 0xb3, 0xff, 0x74, 0x32, 0xcd};
    ...
    std::cout << "ModeECB, ECB_ISO_IEC_7816_4_AES256: \n";
    {
        Krypt::Bytes plain[] = {0x00, 0x01, 0xa2, 0xb3, 0xff, 0x74, 0x32, 0xcd};
    ...
    std::cout << "ModeECB, ECB_ANSI_X9_23_AES256: \n";
    {
        Krypt::Bytes plain[] = {0x00, 0x01, 0xa2, 0xb3, 0xff, 0x74, 0x32, 0xcd};
    ...
    std::cout << "ModeCBC, CBC_ZeroNulls_AES128: \n";
    {
        Krypt::Bytes plain[] = {0x00, 0x01, 0xa2, 0xb3, 0xff, 0x74, 0x32, 0xcd};
        ...
        Krypt::Bytes iv[] = {0x00, 0x01, 0x02, 0x03, 0x04, 0x05, 0x06, 0x07,
                             0x08, 0x09, 0x0a, 0x0b, 0x0c, 0x0d, 0x0e, 0x0f};
    ...
    std::cout << "ModeCBC, CBC_PKCS_5_7_AES128: \n";
    {
        Krypt::Bytes plain[] = {0x00, 0x01, 0xa2, 0xb3, 0xff, 0x74, 0x32, 0xcd};
    ...
    std::cout << "ModeCBC, CBC_ISO_IEC_7816_4_AES128: \n";
    {
        Krypt::Bytes plain[] = {0x00, 0x01, 0xa2, 0xb3, 0xff, 0x74, 0x32, 0xcd};
    ...
    std::cout << "ModeCBC, CBC_ANSI_X9_23_AES128: \n";
    {
        Krypt::Bytes plain[] = {0x00, 0x01, 0xa2, 0xb3, 0xff, 0x74, 0x32, 0xcd};
    ...
    std::cout << "ModeCBC, CBC_ZeroNulls_AES192: \n";
    {
        Krypt::Bytes plain[] = {0x00, 0x01, 0xa2, 0xb3, 0xff, 0x74, 0x32, 0xcd};
    ...
    std::cout << "ModeCBC, CBC_PKCS_5_7_AES192: \n";
    {
        Krypt::Bytes plain[] = {0x00, 0x01, 0xa2, 0xb3, 0xff, 0x74, 0x32, 0xcd};
    ...
    std::cout << "ModeCBC, CBC_ISO_IEC_7816_4_AES192: \n";
    {
        Krypt::Bytes plain[] = {0x00, 0x01, 0xa2, 0xb3, 0xff, 0x74, 0x32, 0xcd};
    ...
    std::cout << "ModeCBC, CBC_ANSI_X9_23_AES192: \n";
    {
        Krypt::Bytes plain[] = {0x00, 0x01, 0xa2, 0xb3, 0xff, 0x74, 0x32, 0xcd};
    ...
    std::cout << "ModeCBC, CBC_ZeroNulls_AES256: \n";
    {
        Krypt::Bytes plain[] = {0x00, 0x01, 0xa2, 0xb3, 0xff, 0x74, 0x32, 0xcd};
    ...
    std::cout << "ModeCBC, CBC_PKCS_5_7_AES256: \n";
    {
        Krypt::Bytes plain[] = {0x00, 0x01, 0xa2, 0xb3, 0xff, 0x74, 0x32, 0xcd};
    ...
    std::cout << "ModeCBC, CBC_ISO_IEC_7816_4_AES256: \n";
    {
        Krypt::Bytes plain[] = {0x00, 0x01, 0xa2, 0xb3, 0xff, 0x74, 0x32, 0xcd};
    ...
    std::cout << "ModeCBC, CBC_ANSI_X9_23_AES256: \n";
    {
        Krypt::Bytes plain[] = {0x00, 0x01, 0xa2, 0xb3, 0xff, 0x74, 0x32, 0xcd};
    ...
    std::cout << "ModeCFB, CFB_ZeroNulls_AES128: \n";
    {
        Krypt::Bytes plain[] = {0x00, 0x01, 0xa2, 0xb3, 0xff, 0x74, 0x32, 0xcd};
    ...
    std::cout << "ModeCFB, CFB_PKCS_5_7_AES128: \n";
    {
        Krypt::Bytes plain[] = {0x00, 0x01, 0xa2, 0xb3, 0xff, 0x74, 0x32, 0xcd};
    ...
    std::cout << "ModeCFB, CFB_ISO_IEC_7816_4_AES128: \n";
    {
        Krypt::Bytes plain[] = {0x00, 0x01, 0xa2, 0xb3, 0xff, 0x74, 0x32, 0xcd};
    ...
    std::cout << "ModeCFB, CFB_ANSI_X9_23_AES128: \n";
    {
        Krypt::Bytes plain[] = {0x00, 0x01, 0xa2, 0xb3, 0xff, 0x74, 0x32, 0xcd};
    ...
    std::cout << "ModeCFB, CFB_ZeroNulls_AES192: \n";
    {
        Krypt::Bytes plain[] = {0x00, 0x01, 0xa2, 0xb3, 0xff, 0x74, 0x32, 0xcd};
    ...
    std::cout << "ModeCFB, CFB_PKCS_5_7_AES192: \n";
    {
        Krypt::Bytes plain[] = {0x00, 0x01, 0xa2, 0xb3, 0xff, 0x74, 0x32, 0xcd};
    ...
    std::cout << "ModeCFB, CFB_ISO_IEC_7816_4_AES192: \n";
    {
        Krypt::Bytes plain[] = {0x00, 0x01, 0xa2, 0xb3, 0xff, 0x74, 0x32, 0xcd};
    ...
    std::cout << "ModeCFB, CFB_ANSI_X9_23_AES192: \n";
    {
        Krypt::Bytes plain[] = {0x00, 0x01, 0xa2, 0xb3, 0xff, 0x74, 0x32, 0xcd};
    ...
    std::cout << "ModeCFB, CFB_ZeroNulls_AES256: \n";
    {
        Krypt::Bytes plain[] = {0x00, 0x01, 0xa2, 0xb3, 0xff, 0x74, 0x32, 0xcd};
    ...
    std::cout << "ModeCFB, CFB_PKCS_5_7_AES256: \n";
    {
        Krypt::Bytes plain[] = {0x00, 0x01, 0xa2, 0xb3, 0xff, 0x74, 0x32, 0xcd};
    ...
    std::cout << "ModeCFB, CFB_ISO_IEC_7816_4_AES256: \n";
    {
        Krypt::Bytes plain[] = {0x00, 0x01, 0xa2, 0xb3, 0xff, 0x74, 0x32, 0xcd};
    ...
    std::cout << "ModeCFB, CFB_ANSI_X9_23_AES256: \n";
    {
        Krypt::Bytes plain[] = {0x00, 0x01, 0xa2, 0xb3, 0xff, 0x74, 0x32, 0xcd};
